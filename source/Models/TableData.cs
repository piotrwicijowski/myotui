...
namespace myotui.Models
{
    public class TableData : ITableData
    {
        ...
        public TableData(IList<IDictionary<string, string>> contentList, IList<string> columnMapOrder, IList<double> columnPorportions)
        {
            var headerContent = columnMapOrder.ToDictionary(x => x, x => x);
            var headerContentList = new List<IDictionary<string,string>>(){headerContent};
